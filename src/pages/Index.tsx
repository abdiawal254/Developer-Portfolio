  ...
  return (
    <ScrollArea {...scrollAreaProps}>
      <div className={`flex flex-col min-h-screen w-full overflow-hidden transition-opacity duration-500 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
        ...
        {/* WhatsApp Button */}
        <WhatsAppButton 
          phoneNumber="254722129118" 
          message="Hi Abdiawal👋! I saw your amazing✨ portfolio and I'm interested in working together🤝 on a project. When would be a good time to chat?"
        />
      </div>
    </ScrollArea>
  );
