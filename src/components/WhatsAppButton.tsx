...
const WhatsAppButton = ({ 
  phoneNumber, 
  message = "Hi Abdiawal! I love your portfolio and would like to discuss a potential project. Are you available?",
  testimonialCount = 25
}: WhatsAppButtonProps) => {
  ...
  const handleClick = () => {
    ...
    const whatsappUrl = `https://wa.me/${+254722129118}?text=${encodeURIComponent(message)}`;
