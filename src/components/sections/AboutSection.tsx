          ...
          <ScrollReveal direction="right">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                I'm a versatile UI/UX designer and software developer with a passion for creating digital experiences that are both beautiful and functional. With a background in Software Engineering and 1 year of experience in the industry, I've developed a holistic approach to product development.
              </p>
              <p className="text-muted-foreground">
